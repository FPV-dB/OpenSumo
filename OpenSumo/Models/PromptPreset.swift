...
extension PromptPreset {
    ...
    private static let hybridStarterPresets: [PromptPreset] = [
        ...
        hybridPreset("Neon Noir Funk", ["Neon Noir Funk", "Cyber Funk", "Dystopian Funk"], ["Night-Time", "Urban", "Dystopian"], bpm: 98, key: "D", mode: "Dorian", vocalType: "Spoken word"),
        ...
        hybridPreset("Neon Noir Atmosphere", ["Neon Noir Atmosphere", "Noir Electronica", "Dark Ambient"], ["Nocturnal", "Urban", "Melancholic"], bpm: 78, key: "F# / Gb", mode: "Lydian", vocalType: "Instrumental"),
